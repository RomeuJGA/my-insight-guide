...
const Terms = () => (
  <LegalLayout title="Termos e Condições">
    ...
    <section>
      ...
      <p>
        Ao aceder e utilizar a Lumen ("Serviço"), o utilizador aceita estes Termos e
    ...
    <section>
      ...
      <p>
        A Lumen é uma ferramenta digital de reflexão pessoal que disponibiliza mensagens
    ...
    <section>
      ...
      <p>
        Todos os conteúdos, incluindo textos, design e marcas, são propriedade da Lumen
    ...
    <section>
      ...
      <p>
        Na máxima extensão permitida por lei, a Lumen não se responsabiliza por
