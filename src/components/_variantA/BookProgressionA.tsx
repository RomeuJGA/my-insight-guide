      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          <div className="p-10 md:p-16 rounded-3xl bg-card border border-border/60 shadow-soft text-center">
            <div className="w-14 h-14 mx-auto rounded-2xl bg-[hsl(165_35%_28%/0.1)] flex items-center justify-center mb-6">
              <BookMarked className="w-6 h-6 text-[hsl(165_35%_28%)]" strokeWidth={1.75} />
            </div>
            <p className="text-sm font-medium text-[hsl(165_35%_28%)] mb-3 uppercase tracking-wider">Caminho</p>
...
export default BookProgressionA;
