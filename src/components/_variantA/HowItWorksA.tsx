    ...
    <section id="how" className="py-24 md:py-32">
      <div className="container">
        <div className="max-w-2xl mx-auto text-center mb-16">
          <p className="text-sm font-medium text-[hsl(165_35%_28%)] mb-3 uppercase tracking-wider">Como funciona</p>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {steps.map((step, i) => (
            ...
            >
              <div className="absolute top-6 right-6 font-serif text-5xl text-muted/60 group-hover:text-[hsl(165_35%_28%/0.2)] transition-smooth">
                0{i + 1}
              </div>
              <div className="w-12 h-12 rounded-2xl bg-[hsl(165_35%_28%/0.1)] flex items-center justify-center mb-6 group-hover:bg-[hsl(165_35%_28%/0.15)] transition-smooth">
                <step.icon className="w-5 h-5 text-[hsl(165_35%_28%)]" strokeWidth={1.75} />
              </div>
